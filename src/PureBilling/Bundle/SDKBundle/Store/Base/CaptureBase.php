...
abstract class CaptureBase extends Action
{
     ...
     * @PBAssert\Type(type="id", idPrefixes={"temp-creditcard", "tempcreditcard", "temp-iban", "tempiban",
     *                                       "creditcard", "internetplus", "paypal",
     *                                       "iban", "paysafecard", "ideal", "giropay", "sofort", "bcmc"})
     * @Store\StoreClass({
